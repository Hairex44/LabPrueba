 ...
 * @author Usuario
 */
public class frmCantidad extends javax.swing.JDialog {
    DefaultTableModel modelo;
    int posi;
    DatosCantidad almacenaCant=new DatosCantidad(20);
    Cantidad cantObj=new Cantidad();
    /**
     * Creates new form frmCantidad
     */
    public frmCantidad(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tblCant = new javax.swing.JTable(){
            ...
            cmbbusca.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "PrecUnita", "Total" }));
            ...
            jScrollPane1.setViewportView(tblCant);
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        ...
        String titulos[] = {"PrecUnita","Total"};
        modelo = new DefaultTableModel(null, titulos);
        for (int i = 0; i < almacenaCant.getNumRegs(); i++) {
            cantObj = almacenaCant.getRegistro(i);
            switch (cmbbusca.getSelectedIndex()) {
                case 0:
                if (String.valueOf(cantObj.getPrecUnit()).contains(txtBuscar.getText())) {
                    Object nuevaFila[] = {cantObj.getPrecUnit(), cantObj.getTotal()};
                    modelo.addRow(nuevaFila);
                }
                break;
                case 1:
                if (String.valueOf(cantObj.getTotal()).contains(txtBuscar.getText())) {
                    Object nuevaFila[] = {cantObj.getPrecUnit(), cantObj.getTotal()};
                    modelo.addRow(nuevaFila);
                }
                break;
        ...
        tblCant.setModel(modelo);
        lblregistro.setText("Cantidad de Registro " + String.valueOf(modelo.getRowCount()));
    }//GEN-LAST:event_txtBuscarKeyReleased

    private void btnagregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnagregarActionPerformed
        // TODO add your handling code here:
        frmAgregaCantidad win = new frmAgregaCantidad(null, true, almacenaCant, -1, 1);
        win.setTitle("Agregar Cantidad Nueva");
        win.setVisible(true);
        almacenaCant = win.almacenaCant;
        cargaTabla();
    }//GEN-LAST:event_btnagregarActionPerformed

    public void cargaTabla() {
        String titulos[] = {"Precio Unitario","Total"};
        modelo = new DefaultTableModel(null, titulos);
        for (int i = 0; i < almacenaCant.getNumRegs(); i++) {
            cantObj = almacenaCant.getRegistro(i);
            Object nuevaFila[] = {cantObj.getPrecUnit(), cantObj.getTotal()};
    ...
    private void btnactualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnactualizarActionPerformed
        ...
        if (respuesta == JOptionPane.YES_OPTION) {
            if (tblCant.getSelectedRow() >= 0) {
            frmAgregaCantidad win = new frmAgregaCantidad(null, true, almacenaCant, tblCant.getSelectedRow(), 2);
            win.setTitle("Actualizar Cantidad");
            win.setVisible(true);
            almacenaCant = win.almacenaCant;
            cargaTabla();
        } else {
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        ...
        if (respuesta == JOptionPane.YES_OPTION) {
            if (tblCant.getSelectedRow() != -1) {
            if (almacenaCant.eliminarCant(posi, cantObj)) {
                JOptionPane.showMessageDialog(this, "Registro Eliminado");
                modelo.removeRow(tblCant.getSelectedRow());
                lblregistro.setText("Cantidad de Registros: " + String.valueOf(modelo.getRowCount()));
            }
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmCantidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmCantidad dialog = new frmCantidad(new javax.swing.JFrame(), true);
